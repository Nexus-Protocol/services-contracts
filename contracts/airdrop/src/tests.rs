...
fn proper_initialization() {
    ...
    assert_eq!("psi0000", config.psi_token.as_str());
...
// Someone created an issue for the bug here: https://github.com/CosmWasm/cosmwasm/issues/985
...
//             contract_addr: "psi0000".to_string(),
//             funds: vec![],
